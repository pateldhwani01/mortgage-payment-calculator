			...
			<div className="grid__container">
				<div className="grid__item">
					<span className="grid__item--header">
						{parseInt(this.props.amountToBorrow).toLocaleString('en-GB', localeOptions)}
					</span>
					<div className="grid__item--label">Amount To Borrow</div>
				</div>
				<div className="grid__item">
					<span className="grid__item--header">
						{parseInt(this.props.monthlyPayment).toLocaleString('en-GB', localeOptions)}
					</span>
					<div className="grid__item--label">Monthly Payment</div>
				</div>
				<div className="grid__item">
					<span className="grid__item--header">
						{parseInt(this.props.totalRepaid).toLocaleString('en-GB', localeOptions)}
					</span>
					<div className="grid__item--label">Total Repaid</div>
				</div>
				<div className="grid__item">
					<span className="grid__item--header">
						{parseInt(this.props.totalInterestPaid).toLocaleString('en-GB', localeOptions)}
					</span>
