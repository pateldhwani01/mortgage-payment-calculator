    ...
    <div className="grid__container">
      <div className="grid__item">
        <span className="grid__item--header">
          {props.purchasingHousePrice.toLocaleString("en-GB", localeOptions)}
        </span>
        <input
          type="range"
          ...
          defaultValue="285000"
          onChange={() => {
            return props.handleMortgageDataChange(
      ...
      <div className="grid__item">
        <span className="grid__item--header">
          {props.depositAmount.toLocaleString("en-GB", localeOptions)}
        </span>
        <input
          type="range"
          className="grid__item--range-slider"
      ...
      <div className="grid__item">
        ...
        <input
          ...
          defaultValue="25"
          onChange={() =>
            props.handleMortgageDataChange(
              parseFloat(document.getElementById("depositAmount").value),
              parseFloat(document.getElementById("purchasingHousePrice").value),
              parseFloat(document.getElementById("mortgageTerm").value),
              parseFloat(document.getElementById("interestRate").value)
